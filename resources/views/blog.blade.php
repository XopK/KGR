                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <article class="post-sm">
                            ...
                            <!-- Post Title -->
                            <div class="post-title">
                                <h3><a href="blog_single.blade.php">Design is not just what it looks like and feels
                                        like.
                                        Design
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-9 text-center text-lg-left">
                                    <div class="content">
                                        ...
                                        <!-- Description -->
                                        <p>Quisque velit nisi, pretium ut lacinia in, elementum id enim. Proin eget
                                            tortor
                                            risus. Vivamus suscipit tortor eget felis porttitor volutpat. </p>
                                    </div>
                                </div>
